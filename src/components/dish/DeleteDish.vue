    ...
    <div class="delete-dish">
        ...
        <el-card class="box-card">
            ...
            <el-form :model="form1" label-width="100px">
                ...
                <el-form-item>
                    <el-button type="danger" @click="handleDeleteNumb">删除</el-button>
                </el-form-item>
            </el-form>
        </el-card>
        <el-card class="box-card">
            ...
            <el-form :model="form2" label-width="100px">
                ...
                <el-form-item>
                    <el-button type="danger" @click="handleDeleteName">删除</el-button>
                </el-form-item>
            </el-form>
        </el-card>
    </div>
...
export default {
    ...
    methods: {
        handleDeleteNumb () {
            this.$confirm(`确认删除编号为${this.form1.did}的菜品`, '警告', {
        ...
        handleDeleteName () {
            this.$confirm(`确认删除名称为${this.form2.dishName}的菜品`, '警告', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'waring'
            }).then(() => {
